...
class ProfileClient : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageButton4.setOnClickListener { val intent=Intent(this, MainActivity::class.java)
            startActivity(intent)}
        imageButton3.setOnClickListener { val  redactor=Intent(this, RedactorClient::class.java)
